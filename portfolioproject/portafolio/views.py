...
def contacto_nuevo(request):
    if request.method == "POST":
        ...
        form = ContactoForm()
    return render(request, 'portafolio/contacto_formulario.html', {'form': form})

@login_required
def contacto_detalle(request, pk):
    contacto = get_object_or_404(Contacto, pk=pk)
    return render(request, 'portafolio/contacto_detalle.html', {'contacto': contacto})
...
def contacto_editar(request, pk):
    ...
    return render(request, 'portafolio/contacto_editar.html', {'form': form})
...
def contacto_lista(request):
    ...
    return render(request, 'portafolio/contacto_lista.html', {'contactos': contactos})

def contacto_confirmacion(request):
    return render(request, 'portafolio/contacto_confirmacion.html')
